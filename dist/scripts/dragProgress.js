...
/***/ function(module, exports, __webpack_require__) {
	...
	var dragprogressTpl = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"index.coffee\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
	    PRICE_CONSTANT = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"PRICE_CONSTANT.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	DragProgress.prototype = {
	    ...
	    initElement: function () {
	        this.container = $(dragprogressTpl({'prices': this.data}));
	        // 拖拽的进度条
	    ...
	    _towardLeftOrRight: function (target, xSpacing) {
	        ...
	        if (towardLeft) {
	            ...
	            progressStyle = $.extend({}, progressStyle, {'left': curLeft});
	        } else {
	            ...
	            this.realRight = curRight;
	            progressStyle = $.extend({}, progressStyle, {'right': curRight});
	        }
	    ...
	    formatData: function (data) {
	        var len = $.isArray(data) && data.length || 0;
